SHELLData2015.2020 <- read.csv("../data/SHELLData2015-2020.csv",sep=";", dec=".")
NYSEnergy2015.2020 <- read.csv("../data/NYSEnergy2015-2020.csv",sep=";", dec=".")

SHELL.P <- SHELLData2015.2020$Ultimo
...
ks <- ksmooth(NYSE.R, SHELL.R, bandwidth = 0.05)  
...
var.shell.r <- systematic.risk + firm.specific.risk

residuals <- resid(ols)


# Plot della densità stimata
...
# Linea del valore stimato di beta
